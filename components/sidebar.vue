<template>
    <nav class="fixed bg-white  h-screen text-forest-green w-72 top-0 -translate-x-80 p-5 z-50 transition-transform duratiion-400 ease-in-out">
        <ul class="flex flex-col">
            <nuxt-link @click="closeSidebar" to="/" class="flex gap-2 items-center border-b border-emerald-green mb-5">
	...
	c33.946,33.946,89.496,33.946,123.442,0l77.422-77.421L275.466,192.81z" />
		...
		C388.473,254.85,385.108,256.133,381.744,256.133z" />
                ...
                <span>
                    <p class="font-bold">SAG-BOL</p>
                    <p class="text-sm">Iň amatly bahadan tap!</p>
                </span>

            </nuxt-link>
            <nuxt-link @click="closeSidebar" to="/" class="p-3 transition-hover ease-in-out hover:border-l-2 border-emerald-green hover:shadow-sm ">
                <i class="pi pi-home"></i>
                Esasy sahypa
            </nuxt-link>
            <nuxt-link @click="closeSidebar(); openSignIn() " to="/" class="p-3 transition-hover ease-in-out hover:border-l-2 border-emerald-green hover:shadow-sm ">
                <i class="pi pi-sign-in"></i>
                Içeri gir</nuxt-link>
                <nuxt-link @click="closeSidebar(); openSignIn() " to="/" class="p-3 transition-hover ease-in-out hover:border-l-2 border-emerald-green hover:shadow-sm ">
                <i class="pi pi-book"></i>
                Lukmançylyk hakda</nuxt-link>
            <li class="p-3 transition-hover ease-in-out hover:border-l-2 border-emerald-green hover:shadow-sm ">
                <i class="pi pi-question-circle"></i>
                Nädip sargyt edilýa?

            </li>
            <nuxt-link @click="closeSidebar" to="/aboutUs" class="p-3 transition-hover ease-in-out hover:border-l-2 border-emerald-green hover:shadow-sm ">
        ...
        <i class="pi pi-times-circle absolute top-1 right-1 text-2xl cursor-pointer" @click="closeSidebar"></i>
    </nav>
</template>
<script>
export default{
