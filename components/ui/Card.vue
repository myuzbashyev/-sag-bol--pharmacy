<template>
  ...
  >
    ...
    c1.596,2.378,2.522,5.162,2.522,8.27C414.196,477.327,413.789,479.246,413.042,481.02z"
        ...
        <div v-else class="flex justify-between w-full bg-lint px-2 rounded">
          ...
          <input
            ...
            inputmode="numeric"
            v-model="numInput"
            class="bg-lint outline-none text-center w-full"
          />
...
const { id, title, price, img, pharmacy, route, isFav } = toRefs(props);
