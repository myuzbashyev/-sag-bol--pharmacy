<template>
  ...
  >
    <Toolbar class="container p-0 bg-transparent border-none relative">
      ...
      <template #center>
        <span
          class="flex items-center bg-search search-600 border rounded-xl px-5 relative"
        >
          <InputText
            v-model="searchQuery"
	...
	c33.946,33.946,89.496,33.946,123.442,0l77.422-77.421L275.466,192.81z"
      ...
      <nav class="flex justify-between flex-1">
        <ul>
          ...
          <li
            class="text-md mb-1 hover:text-emerald-green transition-colors ease-in-out"
          >
            Biz barada
          </li>
          <li
          ...
          <li
            class="text-md hover:text-emerald-green transition-colors ease-in-out"
          >
            Sorag jogap
          </li>
        </ul>
